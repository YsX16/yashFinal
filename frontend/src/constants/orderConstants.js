...
export const CREATE_ORDERMAIL_REQUEST = "CREATE_ORDERMAIL_REQUEST";
export const CREATE_ORDERMAIL_SUCCESS = "CREATE_ORDERMAIL_SUCCESS";
export const CREATE_ORDERMAIL_FAIL = "CREATE_ORDERMAIL_FAIL";
