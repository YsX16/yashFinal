...
const Tags = ["Large Sleves", "Small Sleves", "Emboriny", "Oversized"];
  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <MetaData title="Shop ---Fashionboi" />
          <section id="page-header">
            <h2>#SaveMore</h2>

            <p>save more with coupons & discount upto 50% OFF!</p>
          </section>
              ...
              <div className="contentsss">
                <div className="contentsss-wrapper">
                  <div className="filterBox">
                    <h3 onClick={lowtohigh} className="price-handlers">
                      {" "}
                      Low To High<i className="fas fa-sort-amount-down-alt"></i>{" "}
                    </h3>

                    <h3 onClick={hightolow} className="price-handlers">
                      {" "}
                      High To Low<i className="fas fa-sort-amount-down"></i>
                    </h3>
